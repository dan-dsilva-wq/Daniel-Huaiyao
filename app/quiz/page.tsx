  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-stone-50 to-zinc-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="relative z-10 max-w-2xl mx-auto px-4 py-6 sm:py-12 pb-safe">
          ...
          {activeTab === 'your-questions' && (
            ...
            >
              ...
              {showAddForm ? (
                ...
                <button
                  onClick={() => setShowAddForm(true)}
                  className="w-full py-4 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
        ...
        {/* Floating Add Button - visible on My Questions tab when form is closed */}
        <AnimatePresence>
          {activeTab === 'your-questions' && !showAddForm && (
            <motion.button
