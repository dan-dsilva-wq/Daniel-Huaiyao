# =============================================================================
# OVERNIGHT AI EXPERIMENT v3 - Self-Improving
# =============================================================================
# Usage:
#   .\scripts\overnight-v3.ps1                           # Default run
#   .\scripts\overnight-v3.ps1 -MaxLoops 5               # Short test
#   .\scripts\overnight-v3.ps1 -Goal "Make it awesome"   # Goal mode
#   .\scripts\overnight-v3.ps1 -UseVision                # Use vision file
#   .\scripts\overnight-v3.ps1 -DryRun                   # Test without changes
#
...
function Get-RunAnalysis {
    ...
    $totalLoops = $State.currentLoop
    if ($totalLoops -eq 0) { $totalLoops = 1 }

    $completedCount = if ($State.completedTasks) { @($State.completedTasks).Count } else { 0 }
    ...
    $noOpRate = [math]::Round($State.consecutiveNoOps / $totalLoops, 2)
