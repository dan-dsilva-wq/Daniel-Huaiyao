...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Hive deep value model (PyTorch)")
    parser.add_argument("--dataset", required=True, help="Path to JSON dataset from train-model.ts --dataset-out")
    parser.add_argument("--out", default="lib/hive/trained-model.json", help="Output model JSON path")
    ...
    parser.add_argument(
        "--checkpoint",
        default=".hive-cache/deep-training.ckpt",
